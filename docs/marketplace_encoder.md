...
### func \(\*MarketplaceEncoder\) [ApproveBuyoutListing](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/marketplace_encoder.go#L120-L126>)
...
### func \(\*MarketplaceEncoder\) [ApproveCreateListing](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/marketplace_encoder.go#L258>)
...
### func \(\*MarketplaceEncoder\) [BuyoutListing](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/marketplace_encoder.go#L184-L190>)
...
### func \(\*MarketplaceEncoder\) [CancelListing](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/marketplace_encoder.go#L81>)
...
### func \(\*MarketplaceEncoder\) [CreateListing](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/marketplace_encoder.go#L303>)
...
## type [MarketplaceFilter](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/types.go#L530-L535>)
...
## type [MerkleContent](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/snapshots.go#L35-L37>)

```go
type MerkleContent struct {}
```

### func \(MerkleContent\) [CalculateHash](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/snapshots.go#L39>)

```go
func (t MerkleContent) CalculateHash() ([]byte, error)
```

### func \(MerkleContent\) [Equals](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/snapshots.go#L48>)

```go
func (t MerkleContent) Equals(other merkletree.Content) (bool, error)
```

## type [MerkleNode](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sharded_merkle_tree.go#L263-L265>)

```go
type MerkleNode struct {}
```

### func \(\*MerkleNode\) [Serialize](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sharded_merkle_tree.go#L267>)

```go
func (t *MerkleNode) Serialize() ([]byte, error)
```

## type [Metadata](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/types.go#L18-L21>)
