...
### func [NewThirdwebSDK](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L27>)
...
### func [NewThirdwebSDKFromProvider](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L41>)

```go
func NewThirdwebSDKFromProvider(provider *ethclient.Client, options *SDKOptions) (*ThirdwebSDK, error)
```

### func \(\*ThirdwebSDK\) [GetContract](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L194>)
...
### func \(\*ThirdwebSDK\) [GetContractFromAbi](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L210>)
...
### func \(\*ThirdwebSDK\) [GetEdition](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L108>)
...
### func \(\*ThirdwebSDK\) [GetEditionDrop](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L152>)
...
### func \(\*ThirdwebSDK\) [GetMarketplace](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L180>)
...
### func \(\*ThirdwebSDK\) [GetMultiwrap](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L166>)
...
### func \(\*ThirdwebSDK\) [GetNFTCollection](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L94>)
...
### func \(\*ThirdwebSDK\) [GetNFTDrop](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L138>)
...
### func \(\*ThirdwebSDK\) [GetToken](<https://github.com/qnfnypen/thirdweb-go-sdk/blob/main/thirdweb/sdk.go#L124>)
